  ...
  return (
    <Card className="mx-auto mt-10 max-w-lg text-center">
      ...
      <p className="mx-auto mt-2 max-w-sm text-[12.5px] leading-relaxed text-mist-400">
        The CRM is per brand. This workspace has a seeded pipeline on the real-estate brand —
        switch brands from the header, or start capturing leads for {brandName} and they will appear here.
      </p>
      <Link
